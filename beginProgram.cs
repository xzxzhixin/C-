...
namespace myclass.util
{
    class beginProgram
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "动态壁纸";
        ...
        /// <summary>
        /// 设置开机自动启动-只需要调用改方法就可以了参数里面的bool变量是控制开机启动的开关的，默认为开启不自启启动
        /// </summary>
        /// <param name="onOff">自启开关</param>
        public void SetMeAutoStart(bool onOff = false)
        {
            if (onOff)//开机启动
            {
                //获取启动路径应用程序快捷方式的路径集合
